...
('BO001', N'Bò', N'Simental', N'A1', N'Đực', '2022-05-01', 250.5,'ND002', N'Tốt', NULL),
('DE001', N'Dê', N'Bách Thảo', N'D1', N'Cái', '2023-09-20', 35.7, 'ND002', N'Tốt', NULL);

-- ND001
INSERT INTO dbo.VatNuoi (IDVatNuoi, loai, tenGiong, tenChuong, gioitinh, ngaySinh, canNang, IDNguoiDung, tinhTrangSucKhoe, ghiChu)
VALUES ('LON001', N'Lợn', N'Landrace', N'B3', N'Cái', '2023-02-15', 120.0, 'ND001', N'Bệnh mức 1', N'Cúm');

-- ND003
INSERT INTO dbo.VatNuoi (IDVatNuoi, loai, tenGiong, tenChuong, gioitinh, ngaySinh, canNang, IDNguoiDung, tinhTrangSucKhoe, ghiChu)
VALUES ('GA001', N'Gà', N'Gà Ri', N'C2', N'Đực', '2024-01-10', 2.3, 'ND003', N'Tốt', NULL);

INSERT INTO VatNuoi (IDVatNuoi, loai, tenGiong, tenChuong, gioitinh, ngaySinh, canNang, IDNguoiDung, tinhTrangSucKhoe, ghiChu) VALUES
-- ND004
('HEO008', N'Heo', N'Heo Yorkshire', N'A1', N'Cái', '2024-01-25', 37.2, 'ND004', N'Bệnh mức 2', N'Viêm da'),

-- ND005
('HEO009', N'Heo', N'Heo Yorkshire', N'A1', N'Cái', '2024-01-20', 40.0, 'ND005', N'Tốt', NULL),

-- ND006
('GA009', N'Gà', N'Gà Lương Phượng', N'A3', N'Đực', '2024-02-14', 2.5, 'ND006', N'Bệnh mức 1', N'Cúm'),
('GA010', N'Gà', N'Gà Mía', N'A3', N'Cái', '2024-01-22', 2.0, 'ND006', N'Bệnh mức 3', N'Ung thư'),

-- ND007
('VIT011', N'Vịt', N'Vịt Super M', N'C1', N'Đực', '2024-03-10', 2.8, 'ND007', N'Tốt', NULL),

-- ND008
('BO012', N'Bò', N'Bò Brahman', N'B3', N'Cái', '2023-09-01', 280.0, 'ND008', N'Bệnh mức 1', N'Viêm da'),
('BO013', N'Bò', N'Bò lai Sind', N'B3', N'Đực', '2023-10-10', 260.0, 'ND008', N'Tốt', NULL),

-- ND009
('GA014', N'Gà', N'Gà Tre', N'D1', N'Đực', '2024-03-05', 1.6, 'ND009', N'Đã chết', N'Ung thư'),

-- ND010
('HEO015', N'Heo', N'Heo Landrace', N'A2', N'Cái', '2024-01-18', 33.5, 'ND010', N'Bệnh mức 2', N'Cúm'),

-- ND011
('BO016', N'Bò', N'Bò Red Angus', N'C2', N'Đực', '2023-12-01', 320.0, 'ND011', N'Tốt', NULL),

-- ND012
('VIT017', N'Vịt', N'Vịt cỏ', N'C3', N'Cái', '2024-02-28', 2.3, 'ND012', N'Bệnh mức 3', N'Viêm da'),
('VIT018', N'Vịt', N'Vịt siêu trứng', N'C3', N'Cái', '2024-03-02', 2.6, 'ND012', N'Tốt', NULL),

-- ND013
('GA019', N'Gà', N'Gà Hồ', N'D2', N'Đực', '2024-01-25', 3.0, 'ND013', N'Bệnh mức 1', N'Cúm'),

-- ND014
('HEO020', N'Heo', N'Heo Duroc', N'A4', N'Đực', '2024-02-05', 42.0, 'ND014', N'Tốt', NULL),

-- ND015
('VIT021', N'Vịt', N'Vịt Super M', N'C4', N'Cái', '2024-03-01', 3.2, 'ND015', N'Bệnh mức 2', N'Ung thư'),
('GA022', N'Gà', N'Gà Đông Tảo', N'D3', N'Cái', '2024-03-15', 2.9, 'ND015', N'Tốt', NULL),

-- ND016
('HEO001', N'Heo', N'Heo Landrace', N'A1', N'Đực', '2024-01-01', 35.5, 'ND016', N'Bệnh mức 1', N'Viêm da'),

-- ND017
('GA002', N'Gà', N'Gà Ri', N'A2', N'Cái', '2024-02-15', 2.1, 'ND017', N'Tốt', NULL),
('GA003', N'Gà', N'Gà Đông Tảo', N'A2', N'Đực', '2024-03-01', 2.8, 'ND017', N'Bệnh mức 3', N'Ung thư'),

-- ND018
('VIT004', N'Vịt', N'Vịt Super M', N'A3', N'Cái', '2024-01-10', 3.0, 'ND018', N'Tốt', NULL),

-- ND019
('BO005', N'Bò', N'Bò Simental', N'B1', N'Đực', '2023-12-25', 250.0, 'ND019', N'Bệnh mức 1', N'Cúm'),
('BO006', N'Bò', N'Bò lai Sind', N'B1', N'Cái', '2024-02-10', 180.0, 'ND019', N'Tốt', NULL),
