...
('BO013', N'Bò', N'Bò lai Sind', N'B1', N'Đực', '2023-10-10', 260.0, 'ND008',NULL, N'Tốt');
...
-- ND011
INSERT INTO dbo.VatNuoi (IDVatNuoi, loai, tenGiong, tenChuong, gioitinh, ngaySinh, canNang, IDNguoiDung, tinhTrangSucKhoe, ghiChu) VALUES 
('BO016', N'Bò', N'Bò Red Angus', N'B2', N'Đực', '2023-12-01', 320.0, 'ND011',NULL, N'Tốt');

-- ND012
INSERT INTO dbo.VatNuoi (IDVatNuoi, loai, tenGiong, tenChuong, gioitinh, ngaySinh, canNang, IDNguoiDung, tinhTrangSucKhoe, ghiChu) VALUES 
('VIT017', N'Vịt', N'Vịt cỏ', N'V2', N'Cái', '2024-02-28', 2.3, 'ND012', N'Bệnh mức 3', N'Viêm da'),
('VIT018', N'Vịt', N'Vịt siêu trứng', N'V2', N'Cái', '2024-03-02', 2.6, 'ND012',NULL, N'Tốt');
...
('GA022', N'Gà', N'Gà Đông Tảo', N'G2', N'Cái', '2024-03-15', 2.9, 'ND015',NULL, N'Tốt');
...
-- ND017
INSERT INTO dbo.VatNuoi (IDVatNuoi, loai, tenGiong, tenChuong, gioitinh, ngaySinh, canNang, IDNguoiDung, tinhTrangSucKhoe, ghiChu) VALUES 
('GA002', N'Gà', N'Gà Ri', N'G1', N'Cái', '2024-02-15', 2.1, 'ND017',NULL, N'Tốt'),
...
('BO006', N'Bò', N'Bò lai Sind', N'B2', N'Cái', '2024-02-10', 180.0, 'ND019', NULL, N'Tốt'),
